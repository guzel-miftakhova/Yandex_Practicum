...
Исследование проведено на реальных данных Яндекс.Музыки. Проверила данные и сравнила поведение пользователей двух столиц.
В ходе проекта были:
- определены и обработаны пропуски
- заменены типы данных на соответствующие
- удалены дубликаты
- проведена логическая индексация, группировка, сортировка
...
### Проект: продажа квартир в Санкт-Петербурге — анализ рынка недвижимости (описание в папке проекта)
...
### Проект: определение выгодного тарифа для федерального оператора сотовой связи (описание в папке проекта)
