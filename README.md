...
Работу над этим проектом проведена на удаленной машине в сервисе Yandex.Cloud. 

*В ходе проекта были:*
___
- установлен PostgreSQL, развернута база данных;
- написан скрипт пайплайна, который позволил собирать данные за определенный временной период, и настроена его автономная работа через crontab;
- для визуализации собранных данных написан скрипт дашборда с несколькими фильтрами и также запуск его на удаленной машине;
...
## Часть 13: Выпускной проект:

На основе всех полученных данных в курсе выполнен буткемп-проект по одной из *выбранной областей*:
___
- банки;
- ритейл;
- игры;
